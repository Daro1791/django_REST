    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_data', models.DateField(auto_now_add=True, verbose_name='Creation Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.BooleanField(default=True, verbose_name='State')),
                ('created_data', models.DateField(blank=True, editable=False, verbose_name='Creation Date')),
                ...
                ('category_product', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='products.categoryproduct', verbose_name='Bid Indicator')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'historical Bid Indicator',
                'verbose_name_plural': 'historical Bids Indicator',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_date', models.DateField(auto_now=True, verbose_name='Deleted Date')),
                ('discount_value', models.PositiveSmallIntegerField(default=0)),
                ('category_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.categoryproduct', verbose_name='Bid Indicator')),
            ],
            options={
